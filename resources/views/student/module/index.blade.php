                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <div class="ms-2 me-auto pb-3">
                                ...
                                @if($module->is_passed != 1)
                                    <a  href="{{ route("student.assessment.question", $module->id) }}" class="btn btn-danger text-white @if($module->questions_count < 1) disabled @endif @if($passed == false && $module->is_passed != 1) disabled @endif">
                                ...
                                @else
                                    <a  href="{{ route("student.module.show", $module->id) }}" class="btn btn-success text-white @if($module->questions_count < 1 && !$passed) disabled @endif">
